...
function loadBacklogContent() {
  ...
  let tBody = document
    .getElementById("backlogTable")
    .tBodies.namedItem("backlogTableBody");
...
function register() {
  ...
  if (password.trim() != null && avatar.value) {
    let newUser = {
